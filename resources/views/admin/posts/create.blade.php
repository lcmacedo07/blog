...
@section('content')
    ...
    <div class="container">
        ...
        <h1 class="font-bold mb-3 text-xl">ADICIONAR POST</h1>
                        ...
                        <div class="col-md-6 pb-6">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" id="title" class="form-control" name="title" placeholder="Titulo do Post">
                                </div>
                                @if ($errors->has('title'))
                        ...
                        <div class="col-md-3 pb-3">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="file" id="image" class="form-control" name="image" placeholder="Imagem em Destaque">
                                </div>
                                @if ($errors->has('image'))
                        ...
                        <div class="col-md-12 pb-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="textarea" id="body" class="form-control" name="body" placeholder="Body">
                                </div>
                                @if ($errors->has('body'))
